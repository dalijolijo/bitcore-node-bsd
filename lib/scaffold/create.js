...
var BASE_PACKAGE = {
  description: 'A full BitSend node build with Bitcore',
  repository: 'https://github.com/dalijolijo/bitcore-node-bsd',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-bsd': 'dalijolijo/bitcore-lib-bsd',
    'bitcore-node-bsd': 'dalijolijo/bitcore-node-bsd'
  }
};
