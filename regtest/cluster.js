...
describe('Bitcoin Cluster', function() {
  var node;
  var daemons = [];
  var execPath = path.resolve(__dirname, '../bin/bitsendd');
  var nodesConf = [
    {
      datadir: path.resolve(__dirname, './data/node1'),
      conf: path.resolve(__dirname, './data/node1/bitsend.conf'),
      rpcuser: 'bitcoin',
    ...
    },
    {
      ...
      conf: path.resolve(__dirname, './data/node2/bitsend.conf'),
      rpcuser: 'bitcoin',
      rpcpassword: 'local321',
      rpcport: 30522,
    ...
    },
    {
      ...
      conf: path.resolve(__dirname, './data/node3/bitsend.conf'),
      rpcuser: 'bitcoin',
      rpcpassword: 'local321',
      rpcport: 30523,
