...
console.log('BitSend Service native interface vs. BitSend JSON RPC interface');
console.log('----------------------------------------------------------------------');
...
var bitcoind = require('../').services.Bitcoin({
  node: {
    datadir: process.env.HOME + '/.bitsend',
    network: {
      name: 'testnet'
    }
  }
...
bitcoind.start(function(err) {
  ...
  console.log('BitSend started');
});

bitcoind.on('ready', function() {

  console.log('BitSend ready');
